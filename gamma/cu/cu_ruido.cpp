...
void cu_ruido() {
    ...
    TH1F* histogram = new TH1F("histogram", "Uniformly Distributed Bins", 500, 0, 1023);
    TH1F* histograma = new TH1F("histograma", "Uniformly Distributed Bins", 500, 0, 1023);
    TH1F* subtracao = new TH1F("histograma", "Uniformly Distributed Bins", 500, 0, 1023);
    ...
    std::ifstream file("ruido185.txt");
    if (!file.is_open()) {
    ...
    std::ofstream outputFile("cu_sem_ruido.txt");
    if (!outputFile) {
