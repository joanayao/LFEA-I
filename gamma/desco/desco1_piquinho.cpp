...
void desco1_piquinho() {
    ...
    //Leitura do Ficheiro
    std::ifstream file("desco1_sem_ruido.txt");
    if (!file.is_open()) {
    ...
    histogram->SetTitle("Pico3 meia gaussiana");
    ...
    /*//meia1 gaussiana 186-198
    double amplitude = 4;
    double mean = 195;
    double stddev = 3;
    /*/

    /*//meia2 gaussiana 314-332
    double amplitude = 0.7;
    double mean = 315;
    double stddev = 3;
    /*/

    /*//meia3 gaussiana 270-290
    double amplitude = 5;
    double mean = 276;
    double stddev = 3;
    */
